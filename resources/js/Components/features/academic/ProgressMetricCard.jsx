...
export default function ProgressMetricCard({ label, value, icon, bgClass = 'bg-primary-container/10', textClass = 'text-primary' }) {
    return (
        <div className="bg-white p-4 rounded-xl border border-outline-variant shadow-sm flex items-center gap-4 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md">
