            ...
            <div className="grid grid-cols-2 gap-4">
                {items.map((item, idx) => (
                    <button
                        ...
                        className="bg-surface-container-lowest p-4 rounded-2xl border border-outline-variant flex flex-col items-center justify-center text-center gap-2 hover:bg-primary-container/5 hover:border-primary/30 transition-all duration-300 group shadow-sm active:scale-[0.97] w-full"
                        type="button"
                    >
