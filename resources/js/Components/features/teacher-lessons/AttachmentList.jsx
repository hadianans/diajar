        ...
        <section>
            ...
            <div className="grid gap-3">
                {attachments.map((attachment, idx) => {
                    ...
                    return (
                        <div key={idx} className="flex items-center justify-between p-4 bg-white border border-outline-variant rounded-2xl hover:border-primary transition-all cursor-pointer group shadow-sm">
                            ...
                            <button className="w-10 h-10 rounded-full flex items-center justify-center text-outline group-hover:text-primary group-hover:bg-primary-container/10 transition-all">
                                <Icon name="download" />
                            </button>
                        </div>
                    );
