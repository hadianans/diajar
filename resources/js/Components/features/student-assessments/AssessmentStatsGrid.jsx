...
export default function AssessmentStatsGrid({ stats }) {
    return (
        <section className="grid grid-cols-2 gap-gutter">
            {stats.map((stat, idx) => (
                <div key={idx} className="bg-surface-container-lowest/80 backdrop-blur-[12px] border border-slate-200/80 p-4 rounded-xl flex flex-col items-center justify-center text-center space-y-1 shadow-sm">
